...
//Κατασκευαστης για την βάση δεδομένων
public class RefreshConstra {
    ...
    public RefreshConstra(String mAuthorName, String mPharmacyAddress, String mPharmacyPhone) {
